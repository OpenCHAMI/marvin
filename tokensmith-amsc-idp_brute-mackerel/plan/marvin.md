...
- Step 2: [step-002-establish-baseline-behavior-and-reproducible-test-commands.md](./step-002-establish-baseline-behavior-and-reproducible-test-commands.md)
- Step 3: [step-003-design-token-claim-model-and-configuration-schema-migration.md](./step-003-design-token-claim-model-and-configuration-schema-migration.md)
- Step 4: [step-004-implement-issuer-metadata-and-jwks-exposure.md](./step-004-implement-issuer-metadata-and-jwks-exposure.md)
- Step 5: [step-005-implement-typed-claims-and-configurable-signed-context-claim.md](./step-005-implement-typed-claims-and-configurable-signed-context-claim.md)
- Step 6: [step-006-add-project-scoped-minting-and-authorization-policy-interfaces.md](./step-006-add-project-scoped-minting-and-authorization-policy-interfaces.md)
...
- [ ] 6. Add project-scoped minting and authorization policy interfaces
- [ ] 7. Implement service token issuance
- [ ] 8. Add proof-binding/sender-constrained scaffolding only
- [ ] 9. Implement RFC 8693 token exchange with strict error handling
- [ ] 10. Implement delegation and act claim semantics
- [ ] 11. Implement delegated or envelope token model if required
- [ ] 12. Add logging, audit, and constrained revocation interfaces
- [ ] 13. Update documentation, examples, and migration notes
- [ ] 14. Run full validation, compatibility checks, and security review
